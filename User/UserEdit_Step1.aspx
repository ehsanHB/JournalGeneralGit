<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserEdit_Step1.aspx.cs" Inherits="User_UserEdit_Step1" %>
            ...
            <div class="flex-grid no-responsive-future" style="height: 100%;">
                <div class="row" style="height: 100%">
                    ...
                    <div class="cell auto-size padding20 bg-white OverFlowScrol" id="cell-content">
                        ...
                        <h3 style="padding-left: 5%;">User Edit Step 1 :</h3>
                        ...
                        <div style="padding-left: 5%;">
                            ...
                            <table class="table" style="width: 50%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnUserEdit" runat="server" class="button loading-pulse lighten primary " Text="Edit User And Next Step" ValidationGroup="test"
                                            OnClick="btnUserEdit_Click"></asp:Button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" ID="lblPassworld" Text="Password:" CssClass="lbl fieldlbl"></asp:Label>
                                    </td>
                                    <td>
                                        <div class="input-control text full-size">
                                            <span class=" prepend-icon mif-lock "></span>
                                            <asp:TextBox runat="server" ID="txtbPass" TextMode="Password" placeholder="Password..."></asp:TextBox>
                                            <span class="input-state-error mif-warning"></span>
                                            <span class="input-state-success mif-checkmark"></span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnEditPassword" runat="server" class="button loading-pulse lighten primary " Text="Edit Password" ValidationGroup="test"
                                            OnClick="btnEditPassword_Click"></asp:Button>
                                    </td>
                                    <td></td>
                                </tr>
