<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserEdit_Step2.aspx.cs" Inherits="User_UserEdit_Step2" %>
                ...
                <div class="row" style="height: 100%">
                    ...
                    <div class="cell auto-size padding20 bg-white">
                        ...
                        <table>
                            <tr>
                                <div style="padding-left: 5%;">
                                    ...
                                    <label class="input-control checkbox">
                                        ...
                                        <span class="check"></span>
                                        <span class="caption">Language Editor</span>
                                    </label>
                                    <label class="input-control checkbox">
                            ...
                            <tr>
                                <div style="padding-left: 5%;">
                                    <asp:Button ID="btnRoleEdit" runat="server" class="button loading-pulse lighten primary " Text="Edit Role" ValidationGroup="test"
                                        OnClick="btnRoleEdit_Click"></asp:Button>
                                </div>
                            </tr>
                        </table>
                    </div>
