<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmitOnline_Step2.aspx.cs" Inherits="SubmitOnline_Step2" EnableEventValidation="false" %>
                    ...
                    <div class="cell auto-size padding20 bg-white">
                        ...
                        <div style="padding-left: 5%;">
                            ...
                            <div>
                                ...
                                <asp:Button ID="btnStep3" runat="server" class="button loading-pulse lighten primary" Text="Next Step >" OnClick="btnStep3_Click" OnClientClick="setValue('name','lastname','incharge', 10)"></asp:Button>
