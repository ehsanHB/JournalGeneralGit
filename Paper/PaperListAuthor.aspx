<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaperListAuthor.aspx.cs" Inherits="Paper_PaperListAuthor" %>
                    ...
                    <div class="cell auto-size padding20 bg-white OverFlowScrol" id="cell-content">
                        <div>
                            <ul class="breadcrumbs">
                                ...
                                <li><a href="#">Paper List Author</a></li>
                            </ul>
                        </div>
                            ...
                            <div style="width: 100%;">
                                <asp:GridView ID="gvPapers" runat="server" AutoGenerateColumns="false" CssClass="dataTable striped hovered cell-hovered border bordered "
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Register Continue" ItemStyle-CssClass="GridAlignCenter">
                                            <ItemTemplate >
                                                <asp:LinkButton ID="lnkbContinue" CssClass="mif-arrow-right" runat="server" Text=""  Visible='<%# ContinueToolVisible(Container.DataItem) %>'
                                                    CommandArgument='<%# Eval("Status.ID") + "," + Eval("ID") %>' OnClick="lnkbContinue_Click"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>      
                                        <asp:TemplateField HeaderText="Revise Continue">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkbReviseContinue" CssClass="mif-arrow-right" runat="server" Text=""  Visible='<%# ContinueRevisedToolVisible(Container.DataItem) %>'
                                                    CommandArgument='<%# Eval("Status.ID") + "," + Eval("ID") %>' OnClick="lnkbReviseContinue_Click"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>    
                                    </Columns>
                                </asp:GridView>
