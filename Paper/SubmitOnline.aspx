<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmitOnline.aspx.cs" Inherits="SubmitOnline" EnableEventValidation="false" %>
                    ...
                    <div class="cell auto-size padding20 bg-white OverFlowScrol" id="cell-content">
                        ...
                        <div style="padding-left: 5%;">
                            ...
                            <table class="table" style="width: 55%;">
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-control text full-size">
                                            ...
                                            <asp:TextBox runat="server" ID="txtbTitle" TextMode="SingleLine" placeholder=" Title..."
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Button ID="btnStep2" runat="server" class="button loading-pulse lighten primary full-size" Text="Next Step >" OnClick="btnStep2_Click"></asp:Button>
                                    </td>
                                </tr>
                            </table>
                        </div>
