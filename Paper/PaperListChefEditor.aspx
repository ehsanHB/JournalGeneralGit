<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaperListChefEditor.aspx.cs" Inherits="Paper_PaperList" %>
                    ...
                    <div class="cell auto-size padding20 bg-white OverFlowScrol" id="cell-content">
                        <div>
                            <ul class="breadcrumbs">
                                ...
                                <li><a href="#">Paper List ChefEditor</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-control text full-size">
                                                ...
                                                <asp:TextBox runat="server" ID="txtbTitle" TextMode="SingleLine"
                                                     placeholder=" Title..." TabIndex="1"></asp:TextBox>
                                        ...
                                        <td>
                                            <div class="input-control text full-size">
                                                ...
                                                <asp:TextBox runat="server" ID="txtbKeyWord" TextMode="SingleLine" 
                                                    placeholder=" Key Word..." TabIndex="2"></asp:TextBox>

                                            </div>
                                        </td>
                                        <td>
                                            <div class="side-by-side clearfix" tabindex="3">
                                                <asp:DropDownList runat="server" ID="ddlChefEditor" TabIndex="2"
                                                    class="chosen-select" Style="width: 250px; height: 50px;" 
                                                    data-placeholder="Choose an Email..."  >
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                    </tr>
